...
public class Main5 {
    ...
    if (calcularMedia >= 7){
        JOptionPane.showMessageDialog(null, "Aprovado - Média final: " + calcularMedia, "Média", JOptionPane.INFORMATION_MESSAGE);
    } else {
        JOptionPane.showMessageDialog(null, "Reprovado - Média final: " + calcularMedia, "Média", JOptionPane.INFORMATION_MESSAGE);
    }
}
}